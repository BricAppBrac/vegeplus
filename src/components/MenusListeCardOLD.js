...
// import { useDeleteMenuMutation } from "../feature/menus/menusApiSlice";
...
const MenusListeCard = ({ menu }) => {
  ...
  // const [deleteMenu] = useDeleteMenuMutation(); // Utilisation du hook pour supprimer le menu
  ...
  const handleDeleteMenuValide = async (menu) => {
    ...
    //   await deleteMenu({ id: menu._id });

    //   // Dispatch pour supprimer le menu de la liste des menus
    //   // dispatch(deleteListeMenu(menu._id));
    // } catch (error) {
