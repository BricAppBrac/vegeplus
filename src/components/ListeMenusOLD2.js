...
import { fetchMenuData } from "../feature/menu.slice"; // Importez l'action pour charger les données du menu
  ...
  useEffect(() => {
    ...
    dispatch(fetchMenuData())
      .then((apiData) => {
        ...
        const combinedData = [...listemenus, ...apiData];
        dispatch(getListeMenus(combinedData));
      })
      .then(() => dispatch(setSortMenus(["Croissant", null])))
      .catch((error) => {
